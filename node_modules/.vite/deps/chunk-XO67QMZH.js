...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-ADBIPFLF.js");
  const signature_ = (() => {
...
function decodeAddress(cursor, options = {}) {
  ...
  const wrap2 = (address) => checksum3 ? checksum2(address) : address;
  return [wrap2(fromBytes(slice2(value, -20))), 32];
}
...
function hash(authorization, options = {}) {
  ...
  return keccak2562(concat("0x05", fromHex4(toTuple2(presign ? {
    address: authorization.address,
...
//# sourceMappingURL=chunk-XO67QMZH.js.map
